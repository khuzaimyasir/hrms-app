...
class ThemeProvider with ChangeNotifier {
  ...
  ThemeData themeData() {
    return ThemeData(
      ...
      primarySwatch: isLightTheme ? grey : grey,
      primaryColor: isLightTheme ? white : Color(0xFF1E1F28),
...
class ThemeColor {
  List<Color> gradient;
  Color? backgroundColor,toggleButtonColor,toggleBackgroundColor,textColor;
